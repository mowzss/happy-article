...
1|自动提取|is_content_thum_num', 'help' => '内容字段提取缩略图', 'value' => '', 'extend' => NULL, 'list' => '0', 'module' => 'article', 'status' => '1', 'create_time' => '1736671570', 'update_time' => '1736671570'],
                ['name' => 'is_content_thum_num', 'type' => 'text', 'title' => '缩略图数量', 'group_id' => '7', 'options' => '', 'help' => '自动提取内容字段缩略图数量，默认提取前5张图片，不支持指定排序，且组图字段有内容时不会自动提取', 'value' => '5', 'extend' => NULL, 'list' => '0', 'module' => 'article', 'status' => '1', 'create_time' => '1736671655', 'update_time' => '1736671706'],
...
0|关闭', 'help' => '使用HTML Purifier对主题内容的html进行过滤', 'value' => '0', 'extend' => NULL, 'list' => '0', 'module' => 'article', 'status' => '1', 'create_time' => '1736671976', 'update_time' => '1736671976'],
                ['name' => 'content_purifer_html', 'type' => 'textarea', 'title' => 'HTML过滤规则', 'group_id' => '7', 'options' => '', 'help' => '设置允许使用的的html,推荐使用 h2,h3,h4,h5,p,strong,a[href|title],span[style],img[width|height|alt|src],table 可以根据自己的实际需求进行增删', 'value' => 'h2,h3,h4,h5,p,strong,a[href|title],span,img[width|height|alt|src],table', 'extend' => NULL, 'list' => '0', 'module' => 'article', 'status' => '1', 'create_time' => '1736672068', 'update_time' => '1736672228'],
                ['name' => 'content_purifer_css', 'type' => 'textarea', 'title' => 'CSS过滤规则', 'group_id' => '7', 'options' => '', 'help' => '可自行设置允许的css属性 默认数据 font,font-size,font-weight,font-style,font-family,text-decoration,padding-left,color,background-color,text-align 可根据自己实际需求进行增删', 'value' => 'font,font-size,font-weight,font-style,font-family,text-decoration,padding-left,color,background-color,text-align', 'extend' => NULL, 'list' => '0', 'module' => 'article', 'status' => '1', 'create_time' => '1736672154', 'update_time' => '1736672154'],
